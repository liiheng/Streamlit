...
def story_gen(prompt):
  ...
  The total length of the story is maximum 100 words. Language used is English.
  """
...
def design_gen(prompt):
  system_prompt = """
  You will be given a short story. Generate a prompt for a cover art that is suitable for the story. The prompt is
  for dall-e-2.
  """
  response = client.chat.completions.create(
      model = 'gpt-4o-mini',
